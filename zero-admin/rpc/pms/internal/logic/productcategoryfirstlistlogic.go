...
type ProductCategoryFirstListLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewProductCategoryFirstListLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ProductCategoryFirstListLogic {
	return &ProductCategoryFirstListLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *ProductCategoryFirstListLogic) ProductCategoryFirstList(in *pmsclient.ProductCategoryFirstListReq) (*pmsclient.ProductCategoryListResp, error) {
