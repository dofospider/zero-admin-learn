...
func (l *FlashPromotionSessionDeleteLogic) FlashPromotionSessionDelete(req *types.DeleteFlashPromotionSessionReq) (resp *types.DeleteFlashPromotionSessionResp, err error) {
