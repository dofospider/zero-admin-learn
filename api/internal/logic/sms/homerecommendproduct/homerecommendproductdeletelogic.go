...
func (l *HomeRecommendProductDeleteLogic) HomeRecommendProductDelete(req *types.DeleteHomeRecommendProductReq) (resp *types.DeleteHomeRecommendProductResp, err error) {
