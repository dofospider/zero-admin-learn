...
func IntegrationChangeHistoryListHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := integrationchangehistory.NewIntegrationChangeHistoryListLogic(r.Context(), svcCtx)
