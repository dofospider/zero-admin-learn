...
func FlashPromotionSessionAddHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := flashpromotionsession.NewFlashPromotionSessionAddLogic(r.Context(), svcCtx)
